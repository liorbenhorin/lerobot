...
```bash
# Ensure Pinocchio is installed first when setting up the environment
# Install and initialize Git LFS (Required for large asset files like .usd)
sudo apt-get install git-lfs && git lfs install

# Clone and install LW-BenchHub
